...
class Goby():
    ...
    def get_exchanges_activity(self, content: str = None, exchanges: list = None):
    ...
    ''' Закрыть аккаунт '''
    def close_snb_account(self, account_id):
        with Client(token=self.__tsc_token) as client:
    ...
    def get_accounts(self, content: str = None):
        response = self.get_snb_accounts()
    ...
    def place_order(self, figi: str = "", quantity: int = None, price: float = 0, direction: str = "", account_id: str = "", order_type: str = "", order_id: str = ""):
        with Client(token=self.__tsc_token) as client:
            '''
